...
public class HospitalTriageSystem {
	...
	public static void main(String[] args) {
		...
		triageQueue.add(new Patient("Prince", 5));
		triageQueue.add(new Patient("Pratham", 2));
		triageQueue.add(new Patient("Ayush", 4));
		triageQueue.add(new Patient("Krishna", 7));
		triageQueue.add(new Patient("Aryaman", 1));
